...
╰───────────────╯│ │ quarter      INT │╭─┤ patient_id       INT │ ││ tier      VARCHAR │
                 ...
                 ╰─┤ region_id    INT │ ││ paid         DECIMAL ││ │ plan_name VARCHAR │
                   │ age_band VARCHAR │ │╰──────────────────────╯│ │ plan_type VARCHAR │
                   │ sex      VARCHAR │ │                        │ ╰───────────────────╯
                   ╰──────────────────╯ │                        │
                                        │                        │ ╭───────────────────╮
                   ╭──────────────────╮ │                        │ │   dim_diagnosis   │
...
├───────────────┤   ├──────────────────┤  ├──────────────┤
│·id        int ├╮  │·id           int │ ╭┤·id       int │
│ name  varchar ││  │ date_id      int ├─╯│ date    date │
╰───────────────╯│  │ product_id   int ├─╮╰──────────────╯
                 ╰──┤ store_id     int │ │
╭───────────────╮╭──┤ customer_id  int │ │╭──────────────╮
│ customer_dim  ││  │ promotion_id int │ ││ product_dim  │
├───────────────┤│╭─┤ channel_id   int │ │├──────────────┤
│·id        int ├╯│ │ currency_id  int ├╮╰┤·id       int │
│ email varchar │ │╭┤ employee_id  int ││ │ sku  varchar │
╰───────────────╯ │││ quantity     int ││ ╰──────────────╯
                  │││ unit_price   int ││
╭───────────────╮ │││ total        int ││ ╭──────────────╮
│  channel_dim  │ ││╰──────────────────╯│ │ currency_dim │
├───────────────┤ ││                    │ ├──────────────┤
│·id        int ├─╯│                    ╰─┤·id       int │
...
│ name       varchar │╰─┤ country_id integer ││ │ year      integer │╰─┤ date_key      date ││ │ sku        varchar │
╰────────────────────╯  │ name       varchar ││ │ month     integer │╭─┤ store_id   integer ││ │ name       varchar │
                        ╰────────────────────╯│ ╰───────────────────╯│ │ product_id integer ├╯ ╰────────────────────╯
                                              │                      │ │ quantity   integer │
                                              │ ╭───────────────────╮│ │ revenue    decimal │
                                              │ │     dim_store     ││ ╰────────────────────╯
...
│ name       varchar │╰─┤ country_id integer ││ │ year       integer │╰─┤ date_key      date │
╰────────────────────╯  │ name       varchar ││ │ month      integer │╭─┤ store_id   integer │
                        ╰────────────────────╯│ ╰────────────────────╯│╭┤ product_id integer │
                                              │                       │││ quantity   integer │
                                              │ ╭────────────────────╮│││ revenue    decimal │
                                              │ │     dim_store      │││╰────────────────────╯
...
├─────────────────┤  ├─────────────────┤  ├────────────────┤
│·date_key    int ├╮ │·order_id    int │╭─┤·product_id int │
│ year        int │╰─┤ date_key    int ││ │ sku    varchar │
│ month       int │╭─┤ customer_id int ││ │ name   varchar │
╰─────────────────╯│ │ product_id  int ├╯ ╰────────────────╯
                   │ │ store_id    int ├╮
╭─────────────────╮│ │ amount  decimal ││ ╭────────────────╮
